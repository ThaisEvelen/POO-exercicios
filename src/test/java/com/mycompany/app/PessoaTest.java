...
public class PessoaTest {
    ...
    public void testGetNome() {
        ...
        Autor autor = new Autor("George Orwell", "Americano", TipoAutor.Tradicional);

        Livro[] meusLivros = { new Livro("1984", autor, "Distopia") };


        Pessoa pessoa = new Pessoa("Jess");
        pessoa.setLivros(meusLivros);
    ...
    public void testLivro() {
        ...
        Autor autor = new Autor("George Orwell", "Inglês", TipoAutor.Tradicional);
    ...
    public void testUsuarioComEmprestimoAtualizadoDepois() throws Exception {
        ...
        Autor autor = new Autor("J.K. Rowling", "Britânica", TipoAutor.Tradicional);
    ...
    public void deveCriarArtigoCorretamente() {
        ...
        Autor autor = new Autor("Jessica", "Brasileira", TipoAutor.Usuario);
    ...
    public void deveValidarPublicacaoSemErro() {
        ...
        Autor autor = new Autor("Mario", "Brasileiro", TipoAutor.Tradicional);
